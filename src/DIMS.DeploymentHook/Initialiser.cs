...
[assembly: PreApplicationStartMethod(typeof(DIMS.DeploymentHook.Initialiser), nameof(DIMS.DeploymentHook.Initialiser.Initialise))]

namespace DIMS.DeploymentHook
{
    public static class Initialiser
    {
        ...
        static Initialiser()
        {
            HookName = Environment.GetEnvironmentVariable("DIMS_HOOK_NAME");
